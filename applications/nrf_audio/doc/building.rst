...
The application is by default built in a debug configuration. For release builds, users must specify an appropriate prj.conf file, to, among other things, reduce code size, speed up execution and avoid sensitive information being exposed over debug interfaces.

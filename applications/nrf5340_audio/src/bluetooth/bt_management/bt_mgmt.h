 ...
 *
 * @param	scan_interval	Scan interval in ms, 0 if the previous value should be used
 * @param	scan_window	Scan window in ms, 0 if the previous value should be used
 */
